...
public class Album {
    ...
    @NotNull(message = "You must supply a value for artistId")
    ...
    @NotNull(message = "You must supply a value for labelId")
    private int labelId;

    @NotNull(message = "You must supply a value for listPrice")
